  ...
  return (
    <nav className="w-full h-fit py-4 flex items-center justify-between">
      ...
      <motion.div
        ...
        className="bg-muted shadow-none flex md:hidden cursor-pointer text-primary"
        onClick={toggleMenu}
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed flex flex-col md:hidden top-16 left-0 w-full bg-background z-50 overflow-hidden border-t border-border"
          >
