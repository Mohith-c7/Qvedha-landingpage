      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <SlideEffect isSpring={false} delay={0.1} className="text-base">
          <Card className="bg-muted/50">
            <div className="capitalize text-start text-primary font-medium">{settings.plan_1.planName}</div>
            <div className="flex items-baseline gap-1">
              <span className="font-medium text-4xl text-primary">{settings.plan_1.currency}{settings.plan_1.price}</span>
              <span className="text-sm text-foreground/70">/month</span>
            </div>
            <Button className="w-full">{settings.plan_1.cta}</Button>
            <div className="text-start space-y-6">
              <p className="text-foreground/70 text-sm">{settings.plan_1.description}</p>
        ...
        <SlideEffect isSpring={false} delay={0.2} className="flex flex-col gap-6 text-base">
          <Card className="bg-gradient-to-b from-muted/80 to-muted/40 border-accent/30">
            <div className="w-full flex items-center gap-2 justify-between">
              <div className="capitalize text-start text-primary font-medium">{settings.plan_2.planName}</div>
              <div className="text-xs bg-secondary/20 border border-accent text-accent px-2 py-1 rounded-full capitalize">most popular</div>
            </div>
            <div className="flex items-baseline gap-1">
              <span className="font-medium text-4xl text-primary">{settings.plan_2.currency}{settings.plan_2.price}</span>
              <span className="text-sm text-foreground/70">/month</span>
            </div>
            <Button className="w-full" variant='secondary'>{settings.plan_2.cta}</Button>
            <div className="text-start space-y-6">
              <p className="text-foreground/70 text-sm">{settings.plan_2.description}</p>
        ...
        <SlideEffect isSpring={false} delay={0.3} className="flex flex-col gap-6 text-base">
          <Card className="bg-muted/50">
            <div className="capitalize text-start text-primary font-medium">{settings.plan_3.planName}</div>
            <div className="flex items-baseline gap-1">
              <span className="font-medium text-4xl text-primary">{settings.plan_3.currency}{settings.plan_3.price}</span>
              <span className="text-sm text-foreground/70">/month</span>
            </div>
            <Button className="w-full">{settings.plan_3.cta}</Button>
            <div className="text-start space-y-6">
              <p className="text-foreground/70 text-sm">{settings.plan_3.description}</p>
